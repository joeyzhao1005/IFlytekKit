...
public class UnderstandResponse {
    ...
    public UnderstandResponse clone() {
        ...
        understandResponse.service = this.service;
        understandResponse.operation = this.operation;
        understandResponse.text = this.text;
        understandResponse.data = this.data;
        understandResponse.answer = this.answer;
        understandResponse.semantic = this.semantic;
        understandResponse.rc = this.rc;
